...
plot_TotalProtein1 <- ggplot(data= df_scans_average, aes(x = X1015X1026, y = TotalProt))+
  ...
  geom_errorbar(aes(ymin= TotalProt-c(0.000593127,0.0006018644,0.0003908174,0.0004074324), ymax= TotalProt+c(0.000593127,0.0006018644,0.0003908174,0.0004074324)), size=0.3, width = 0.00007)+
